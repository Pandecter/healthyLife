              ...
              <div class="d-flex">
                ...
                >
                  <v-card>
                    ...
                    <v-card-text>
                      <p>
                        Минимальная активность. Сидячая работа, не требующая значительных физических нагрузок.
                      </p>
                      <p>
                        Слабый уровень активности. Интенсивные упражнения не менее 20 минут один-три раза в неделю.
                      ...
                      <p>
                        Умеренный уровень активности. Интенсивная тренировка не менее 30-60 мин три-четыре раза в неделю
                        (любой из перечисленных выше видов спорта).
                      </p>
                      <p>
                        Тяжелая или трудоемкая активность. Интенсивные упражнения и занятия спортом 5-7 дней в неделю.
                      ...
                      <p>
                        Экстремальный уровень. Включает чрезвычайно активные и/или очень энергозатратные виды деятельности:
